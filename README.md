...
The ***ROS2RPI HAT*** enhances the capabilities of your Raspberry Pi by providing a range of features, including:
...
<div class="img_dv">
  <figure class="img_fg50">
    <img class="img_sh" src="images/ros2rpi_top.jpg" alt="ROS2RPI Hat" style="width: 100%;">
  </figure>
</div>
